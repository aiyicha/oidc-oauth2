...
import com.auth2.server.openid.connect.assertion.AssertionOAuth2RequestFactory;
import com.auth2.server.openid.connect.assertion.JWTBearerAssertionAuthenticationToken;
...
public class JWTAssertionTokenGranter extends AbstractTokenGranter {
	...
	@Resource(name = "jwtAssertionTokenFactory")
