 ...
 *******************************************************************************/
package com.auth2.server.openid.connect.web;

import com.auth2.server.openid.connect.view.HttpCodeView;
import com.auth2.server.openid.connect.view.JsonEntityView;
...
public class DiscoveryEndpoint {
	...
	public String providerConfiguration(Model model) {
		...
		if (baseUrl == null || "".equals(baseUrl)) {
			logger.error("Configured issuer is empty!");
			throw new IllegalArgumentException("Configured issuer is empty!");
		}
		...
		m.put("authorization_endpoint", baseUrl + "oauth/authorize");
