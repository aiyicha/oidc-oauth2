...
public class JpaOAuth2ClientRepository implements OAuth2ClientRepository {
	...
	public JpaOAuth2ClientRepository() {
		System.out.println("JpaOAuth2ClientRepository initialized!!!");
	}

	private FactoryBean<EntityManagerFactory> factoryFactoryBean;

	@Autowired
	public void setDefaultPersistenceUnit(FactoryBean<EntityManagerFactory> factoryFactoryBean) {
		this.factoryFactoryBean = factoryFactoryBean;
		System.out.println("defaultPersistenceUnit injection finished!!!");
	}
