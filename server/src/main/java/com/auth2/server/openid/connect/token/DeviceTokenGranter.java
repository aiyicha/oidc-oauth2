...
package com.auth2.server.openid.connect.token;

import com.auth2.server.openid.connect.exception.AuthorizationPendingException;
import com.auth2.server.openid.connect.exception.DeviceCodeExpiredException;
...
public class DeviceTokenGranter extends AbstractTokenGranter {
	 ...
	 * @param grantType
	 */
	protected DeviceTokenGranter(@Qualifier("defaultOAuth2ProviderTokenService") AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory) {
